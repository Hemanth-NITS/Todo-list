...
document.getElementById("addBtn").addEventListener("click", (e) => {
    ...
    localStorage.setItem("allTodo", JSON.stringify(data)); // updating todo data in localstorage
    displayTodo(); // re-rendering todos/tasks
    todoInput.value = "";
});
...
function removeTodo(id) {
    ...
    displayTodo(); // re-render todos/tasks
}
